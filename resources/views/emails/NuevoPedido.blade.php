    ...
    <tr>
      ...
      <td align="center" bgcolor="#ffffff" style="font-family: 'Montserrat', sans-serif; padding:25px;">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="center" style="color: #1D99BF; font-weight: 700; text-transform: uppercase; word-spacing: 2px; font-size: 18px; padding: 18px 0 18px 0;">Nuevo pedido</td>
          </tr>
          ...
          <tr>
            <td align="center" style="color: #EF597D; font-size: 14px; line-height: 24px; padding: 15px 10px 15px 10px;">El pedido tendrá que ser enviado a la siguiente dirección:</td>
          </tr>
          ...
          <tr>
            <td align="center" style="color: #1D99BF; font-size: 16px; font-weight: 700; text-transform: uppercase; line-height: 24px; padding: 15px 10px 6px 10px;">Productos por entregar</td>
          </tr>
