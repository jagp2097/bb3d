    ...
    <tr>
      ...
      <td align="center" bgcolor="#ffffff" style="font-family: 'Montserrat', sans-serif; padding:25px;">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="center" style="color: #1D99BF; font-weight: 700; text-transform: uppercase; word-spacing: 2px; font-size: 18px; padding: 18px 0 18px 0;">Restaurar contraseña</td>
          </tr>
          
          <tr>
            <td align="center" style="color: #EF597D; font-size: 14px; line-height: 24px; padding: 15px 10px 15px 10px;">Ha recibido este correo electrónico porque tenemos una solicitud para restaurar la contraseña de su cuenta.</td>
          </tr>
          
          <tr>
            <td align="center" style="color: #EF597D; font-size: 14px; line-height: 24px; padding: 15px 25px 15px 25px;">
                <a style="background: #8BBC3C; text-decoration: none; font-size: .875rem; border: 0; border-radius: 3px; padding: .4rem .6rem; margin: .1rem; color: #fff;" href="{{ $url }}">Restaurar contraseña</a>                    
            </td>
          </tr>
          
          <tr>
            <td align="center" style="color: #EF597D; font-size: 14px; line-height: 24px; padding: 15px 10px 15px 10px;">
                Este link expirará dentro de 60 minutos.
            </td>
          </tr>

          <tr>
            <td align="center" style="color: #EF597D; font-size: 14px; line-height: 24px; padding: 15px 10px 15px 10px;">
                Si no solicitaste restaurar tu contraseña, haga caso omiso a este mensaje.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style="color: #EF597D; font-size: 12px; line-height: 20px; padding: 15px 12px 0 12px;" align="center" >
                Si estas teniendo problemas al dar click sobre el botón "Restaurar contraseña", 
